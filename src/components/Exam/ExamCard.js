...
const ExamCard = (props) => {
  return (
    <div class=" m-2 w-72 text-left border-primary border-1 text-textColor rounded-md shadow-lgPrimary cursor-pointer">
      <div
      ...
      >
        ...
        <p class="truncate">{props.subjectName}</p>
        <p class="truncate">{props.tname}</p>
        <p class="truncate">{props.dueDate}</p>
      </div>
      {/* <div class="p-4">
        {true ? (
